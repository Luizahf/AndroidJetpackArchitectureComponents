...
import com.anushka.androidArchitectureComponents.databinding.FragmentHomeBinding
    ...
    override fun onCreateView(
        ...
        binding.button.setOnClickListener {
            if (!TextUtils.isEmpty(binding.editText.text.toString())) {
                ...
                Toast.makeText(activity, "Please insert yout name", Toast.LENGTH_LONG).show()
            }
        }
